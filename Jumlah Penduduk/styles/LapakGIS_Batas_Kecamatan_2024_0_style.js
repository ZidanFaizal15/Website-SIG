...
var style_LapakGIS_Batas_Kecamatan_2024_0 = function(feature, resolution){
    ...
    var value = feature.get("SHP Gis_Jumlah penduduk");
    var labelText = "";
    size = 0;
    ...
    if (value > 146.000000 && value <= 66430.666667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 66430.666667 && value <= 132715.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 132715.333333 && value <= 199000.000000) {
            style = [ new ol.style.Style({

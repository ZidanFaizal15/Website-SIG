...
var style_LapakGIS_Batas_Kecamatan_2024_0 = function(feature, resolution){
    ...
    var value = feature.get("SHP Gis_Posyandu");
    var labelText = "";
    size = 0;
    ...
    if (value > 48.000000 && value <= 72.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 72.400000 && value <= 96.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 96.800000 && value <= 121.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 121.200000 && value <= 145.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 145.600000 && value <= 170.000000) {
            style = [ new ol.style.Style({
